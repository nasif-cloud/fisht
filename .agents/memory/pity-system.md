...
Pity thresholds are S 250, SS 1000, and UR 2500. Each tier has its own persistent counter; daily `pullsUsed` resets do not affect pity. The highest eligible guarantee wins, lower-tier counters reset with that guarantee, and higher-tier progress is preserved.

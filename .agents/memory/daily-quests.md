...
**How to apply:** Route future questable actions through the shared quest progress helper, keep quest claims responsible for the 1,000 Beli/30 XP rewards and final 1 Meat bonus, count duel participation only after acceptance, count duel wins only when a winner is determined, preserve the settings-controlled quest reset DM, and combine multiple reset reminders into one bulleted DM headed `More than 1 reminders ready:`.
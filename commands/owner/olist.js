...
module.exports = {
  ...
  async execute(message) {
    ...
    const list = [
      '─── OWNER COMMANDS ───',
      '',
      'op ogive @user [item] [amount]  — give beli, meat, wine, beer, or chest',
      'op nogive @user [item] [amount] — remove beli, meat, wine, beer, or chest',
      ...
      'op nomeat @user [amount]        — remove Meat from a user (legacy)',
